...
function Contact() {
    ...
    <Container>
        ...
        <DiscriptionP>Currently looking for new oppertunities. Whether you have a question or just want to say hi. feel free to send me an email or connect on Linkedin</DiscriptionP>
